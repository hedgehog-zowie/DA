...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="flow/trend" method="post" rel="pagerForm"
          id="report_form">
        <div class="searchBar">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li><a id="downloadExcel"
                   href="flow/trend/download?type=xlsx&startDate=${startDate }&endDate=${endDate}"
                   class="icon"><span>导出EXCEL</span></a></li>
            <li><a id="downloadCSV"
                   href="flow/trend/download?type=csv&startDate=${startDate }&endDate=${endDate}"
                   class="icon"><span>导出CSV</span></a></li>
            <li><a id="downloadPPT"
                   href="flow/trend/download?type=pptx&startDate=${startDate }&endDate=${endDate}"
                   class="icon"><span>导出PPT</span></a></li>
        </ul>
    </div>

    <div class="tabsContent" id="reportTable" layoutH="115">
        <div id="trendReport" style="overflow-y:scroll; height:350px">
            ${report}
        </div>
        <div class="panelBar" style="height: 5px"/>
        <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
        <div id="trendChart" style="overflow-y:scroll; height:350px" />
        <script src="resources/js/flow/flow-trend.js"></script>
    </div>
