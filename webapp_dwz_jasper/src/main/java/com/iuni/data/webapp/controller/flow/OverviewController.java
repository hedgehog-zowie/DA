...
public class OverviewController {
    ...
    public ModelAndView view(@RequestParam(value = "pageNum", required = false) Integer currentPage,
        ...
        String reportContent = reportService.report(ReportFile.flowOverView, params, false, page);
        modelAndView.addObject("report", reportContent);

        modelAndView.setViewName(PageName.flow_overview.getPath());
        return modelAndView;
    }
    ...
    public void download(String startDate, String endDate, String type, HttpServletResponse response) {
        ...
        try {
            reportService.download(ReportFile.flowOverView, type, response, params, false);
        } catch (Exception e) {
