package com.iuni.data.webapp.sso.service.impl;

import com.google.common.collect.Lists;
import com.iuni.data.webapp.sso.exception.ServiceException;
...
public class AccountServiceImpl implements AccountService {
	...
	public ShiroUser getCurrentUser() {
        ...
        try {
            ...
            user = new ShiroUser((long) 0, "errorUser");
        }
		return user;
	}
	...
	public void authenticate(String loginName, String password) {
		...
		try {
			...
			logger.debug("AccountServiceImpl.authenticate invoke success.");
	...
	public List<Menu> getPermissions(Long userId) {
		...
		menu2.setPath("/download/purchaseInReport!listSummary.action");
		child.add(menu2);
		...
		menu2.setParent_id(2L);
		menu2.setPath("/download/purchaseInReport!listDetail.action");
		child.add(menu2);
		...
		menu2.setParent_id(2L);
		menu2.setPath("/download/salesOutReport!listSummary.action");
		child.add(menu2);
		...
		menu2.setParent_id(2L);
		menu2.setPath("/download/salesOutReport!listDetail.action");
		child.add(menu2);
