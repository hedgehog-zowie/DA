 ...
 */
public class NotInWarrantyDetailsTableDto extends AbstractTableDto {
    ...
    public static List<Map<String, Object>> generateTableData(List<NotInWarrantyDetailsTableDto> notInWarrantyDetailTableDtoList) {
        List<Map<String, Object>> tableData = new ArrayList<>();
        for(NotInWarrantyDetailsTableDto notInWarrantyDetailTableDto: notInWarrantyDetailTableDtoList){
