                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="table_channel_type_new" class="btn green">
                                                添加 <i class="fa fa-plus"></i>
                                            </button>
                                            <button id="table_channel_type_delete" class="btn red">
                                    ...
                                    <div class="col-md-6">
                                        <div class="btn-group pull-right">
                                            <button id="table_channel_type_export" class="btn yellow">
                            ...
                            <table id="table_channel_type" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th class="table-checkbox"><input type="checkbox" class="group-checkable"
                                                                      data-set="#table_channel_type .checkboxes"/></th>
                                    <th>渠道类型编码</th>
                                    <th>渠道类型名称</th>
                                    <th>创建日期</th>
                                    <th>备 注</th>
                                ...
                                <c:forEach items="${channelTypeList}" var="channelType">
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" class="checkboxes" value="${channelType.id}"/></td>
                                        <td>${channelType.code}</td>
                                        <td>${channelType.name}</td>
                                        <td>${channelType.createDate}</td>
                                        <td>${channelType.desc}</td>
                                        <td>
                                            <a class="edit" id="edit_${channelType.id}" href="javascript:;"><i
                                                    class="fa fa-pencil text-green"></i> 编辑 </a>
                                            |
                                            <a class="delete" id="delete_${channelType.id}" href="javascript:;"><i
