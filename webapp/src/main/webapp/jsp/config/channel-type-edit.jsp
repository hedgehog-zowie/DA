                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form:form id="form_channel_type" class="form-horizontal" action="/config/channelType/save"
                                       method="post"
                                       modelAttribute="channelType">
                                <div class="form-body">
                                    ...
                                    <form:input type="hidden" id="channelType-id" name="id" value="${channelType.id}"
                                                path="id"/>
                                    ...
                                    <div class="form-group">
										...
										* </span>
                                        ...
                                        <div class="col-md-4">
                                            <form:input type="text" name="code" value="${channelType.code}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="code"/>
                                        </div>
                                    ...
                                    <div class="form-group">
										...
										* </span></name>
                                        ...
                                        <div class="col-md-4">
                                            <form:input name="name" value="${channelType.name}" type="text"
                                                        data-required="1"
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button id="cancel_form_channel_type" type="button" class="btn default">取消
                                            </button>
                                        </div>
                                    </div>
                                </div>
