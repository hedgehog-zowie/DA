        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_distribution_return_goods_details" class="form-horizontal"
                               action="/distribution/returnGoodsDetails/query"
                               method="post"
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="distribution-return-goods-details-table-tab"
                         style="position: relative;">
                        <table id="distribution-return-goods-details-table"
                            ...
                            <c:forEach items="${resultList}" var="result">
                                <tr class="odd gradeX">
                                    ...
                                    <td>${result.backCode}</td>
                                    <td>${result.imei}</td>
                                    <td>${result.handledBy}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
...
<script>
    jQuery(document).ready(function () {
        ReturnGoodsDetailsOfDistribution.init();
    });
</script>
</body>
</html>
