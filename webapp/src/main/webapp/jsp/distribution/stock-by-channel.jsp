...
<head>
    <meta charset="UTF-8">
    <title>数据分析平台 | 各渠道进退换数量汇总报表</title>
        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_distribution_stock_by_channel" class="form-horizontal"
                               action="/distribution/stockByChannel/query"
                               method="post"
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-0 pull-right">
                                    ...
                                    <button id="distribution-stock-by-channel-table-export" class="btn green">
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right" id="distribution-stock-by-channel-tab">
                    <li class="pull-left header"><i class="fa fa-inbox"></i> 各渠道进退换数量汇总</li>
                </ul>
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="distribution-stock-by-channel-table-tab"
                         style="position: relative;">
                        <table id="distribution-stock-by-channel-table"
                            ...
                            <c:forEach items="${resultList}" var="result">
                                <tr class="odd gradeX">
                                    ...
                                    <td>${result.send}</td>
                                    <td>${result.back}</td>
                                    <td>${result.backOfExchange}</td>
                                    <td>${result.reject}</td>
                                    <td>${result.backOfScalping}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
...
<script src="/resources/scripts/distribution/stock-by-channel.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function () {
        StockByChannelOfDistribution.init();
    });
</script>
</body>
</html>
