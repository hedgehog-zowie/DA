        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_financial_stock_details" class="form-horizontal"
                               action="/financial/stockDetails/query"
                               method="post"
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="financial-stock-details-table-tab"
                         style="position: relative;">
                        <table id="financial-stock-details-table"
