        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_financial_stock_move_details" class="form-horizontal"
                               action="/financial/stockMoveDetails/query"
                               method="post"
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="financial-stock-move-details-table-tab"
                         style="position: relative;">
                        <table id="financial-stock-move-details-table"
...
<script>
    jQuery(document).ready(function () {
        StockMoveDetailsOfFinancial.init();
    });
</script>
</body>
</html>
