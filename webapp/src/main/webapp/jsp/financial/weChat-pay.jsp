        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_financial_weChat_pay" class="form-horizontal"
                               action="/financial/weChatPay/query"
                               method="post"
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-0 pull-right">
                                    ...
                                    <button id="financial-weChat-pay-table-export" class="btn green">
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right" id="financial-weChat-pay-tab">
                    <li class="pull-left header"><i class="fa fa-inbox"></i> 微信支付</li>
                </ul>
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="financial-weChat-pay-table-tab"
                         style="position: relative;">
                        <table id="financial-weChat-pay-table"
                            ...
                            <c:forEach items="${resultList}" var="result">
                                <tr class="odd gradeX">
                                    ...
                                    <td>${result.weChatOrderSn}</td>
                                    <td>${result.mchOrderSn}</td>
                                    <td>${result.merchandise}</td>
                                    <td>${result.userSign}</td>
                                    <td>${result.status}</td>
                                    <td>${result.amount}</td>
...
<script src="/resources/scripts/financial/weChat-pay.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function () {
        WeChatPayOfFinancial.init();
    });
</script>
</body>
</html>
