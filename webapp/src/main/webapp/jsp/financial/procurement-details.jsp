        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_financial_procurement_details" class="form-horizontal"
                               action="/financial/procurementDetails/query"
                               method="post"
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right" id="financial-procurement-details-tab">
                    <li>
                        <button id="financial-procurement-details-table-export" class="btn green">
                            导出 <i class="fa fa-file"></i>
                        </button>
                    </li>
                    <li class="pull-left header"><i class="fa fa-inbox"></i> 入库明细</li>
                </ul>
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="financial-procurement-details-table-tab"
                         style="position: relative;">
                        <table id="financial-procurement-details-table"
...
<script src="/resources/scripts/financial/procurement-details.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function () {
        ProcurementDetailsOfFinancial.init();
    });
</script>
</body>
</html>
