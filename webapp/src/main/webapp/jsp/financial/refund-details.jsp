        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_financial_refund_details" class="form-horizontal"
                               action="/financial/refundDetails/query"
                               method="post"
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-0 pull-right">
                                    ...
                                    <button id="financial-refund-details-table-export" class="btn green">
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right" id="financial-refund-details-tab">
                    <li class="pull-left header"><i class="fa fa-inbox"></i> 订单退款明细</li>
                </ul>
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="financial-refund-details-table-tab"
                         style="position: relative;">
                        <table id="financial-refund-details-table"
...
<script src="/resources/scripts/financial/refund-details.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function () {
        RefundDetailsOfFinancial.init();
    });
</script>
</body>
</html>
