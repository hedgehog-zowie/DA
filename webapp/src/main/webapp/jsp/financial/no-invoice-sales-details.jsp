        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_financial_no_invoice_sales_details" class="form-horizontal"
                               action="/financial/noInvoiceSalesDetails/query"
                               method="post"
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right" id="financial-no-invoice-sales-details-tab">
                    <li>
                        <button id="financial-no-invoice-sales-details-table-export" class="btn green">
                            导出 <i class="fa fa-file"></i>
                        </button>
                    </li>
                    <li class="pull-left header"><i class="fa fa-inbox"></i> 未开票销售明细</li>
                </ul>
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="financial-no-invoice-sales-details-table-tab"
                         style="position: relative;">
                        <table id="financial-no-invoice-sales-details-table"
...
<script src="/resources/scripts/financial/no-invoice-sales-details.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function () {
        NoInvoiceSalesDetailsOfFinancial.init();
    });
</script>
</body>
</html>
