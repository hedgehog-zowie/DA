        ...
        <section class="content">
            ...
            <div class="portlet box grey">
                ...
                <div class="portlet-body form">
                    <form:form id="form_operation_user" class="form-horizontal"
                               action="/operation/user/query"
                               method="post"
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-0 pull-right">
                                    ...
                                    <button id="operation-user-table-export" class="btn red-flamingo">
            ...
            <div class="nav-tabs-custom portlet box grey">
                ...
                <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right" id="operation-user-tab">
                    <li class="pull-left header"><i class="fa fa-inbox"></i> 商品销售</li>
                </ul>
                <div class="tab-content no-padding">
                    <div class="portlet-body tab-pane active" id="operation-user-table-tab"
                         style="position: relative;">
                        <table id="operation-user-table"
                            ...
                            <c:forEach items="${resultList}" var="result">
                                <tr class="odd gradeX">
                                    ...
                                    <td>${result.one_day_stay}</td>
                                    <td>${result.two_three_days_stay}</td>
                                    <td>${result.four_seven_days_stay}</td>
                                    <td>${result.eight_thirty_days_stay}</td>
                                    <td>${result.thirtyOne_ninety_days_stay}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
...
<script src="/resources/scripts/operation/user.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function () {
        UserOfOperation.init();
    });
</script>
</body>
</html>
