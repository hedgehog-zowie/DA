var StockByChannelOfDistribution = function () {

    var initTable = function () {

        var table = $('#distribution-stock-by-channel-table');
        ...
        var tableWrapper = jQuery('#distribution-stock-by-channel-table_wrapper');
        ...
        $('#distribution-stock-by-channel-table-export').click(function (e) {
            e.preventDefault();
            var dateRangeString = $("#daterangepicker").val();
            var queryParams = {
                "dateRangeString": dateRangeString,
            }
            location.href = "/distribution/stockByChannel/exportExcel?queryParamStr=" + JSON.stringify(queryParams);
        });
    }
