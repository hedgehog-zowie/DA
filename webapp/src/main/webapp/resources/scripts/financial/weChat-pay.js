var WeChatPayOfFinancial = function () {

    var initTable = function () {

        var table = $('#financial-weChat-pay-table');
        ...
        var tableWrapper = jQuery('#financial-weChat-pay-table_wrapper');
        ...
        $('#financial-weChat-pay-table-export').click(function (e) {
            e.preventDefault();
            var dateRangeString = $("#daterangepicker").val();
            var queryParams = {
                "dateRangeString": dateRangeString,
            }
            location.href = "/financial/weChatPay/exportExcel?queryParamStr=" + JSON.stringify(queryParams);
        });
    }
