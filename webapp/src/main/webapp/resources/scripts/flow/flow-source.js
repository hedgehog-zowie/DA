...
require(
    ...
    function (ec) {
        ...
        var chart = ec.init(document.getElementById('sourceChart'), 'macarons');
        ...
        var beginDate = $("#flow_source_startDate").val();
        var endDate = $("#flow_source_endDate").val();
        var url = "flow/source/data?startDate=" + beginDate + "&endDate=" + endDate;
        $.ajax({
            type: "POST",
            async: false, //同步执行
            dataType: "json",
