var RegisterOfOperation = function () {

    var initTable = function () {

        var table = $('#operation-register-table');
        ...
        var tableWrapper = jQuery('#operation-register-table_wrapper');
        ...
        $('#operation-register-table-export').click(function (e) {
            e.preventDefault();
            ...
            location.href = "/operation/register/exportExcel?queryParamStr=" + JSON.stringify(queryParams);
        });
    }
