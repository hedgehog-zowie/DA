var UserOfOperation = function () {

    var initTable = function () {

        var table = $('#operation-user-table');
        ...
        var tableWrapper = jQuery('#operation-user-table_wrapper');
        ...
        $('#operation-user-table-export').click(function (e) {
            e.preventDefault();
            ...
            location.href = "/operation/user/exportExcel?queryParamStr=" + JSON.stringify(queryParams);
        });
    }
