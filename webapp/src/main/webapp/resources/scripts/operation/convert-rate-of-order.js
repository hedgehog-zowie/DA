var ConvertRateOfOperation = function () {
    ...
    var initTable = function () {
        ...
        var table = $('#operation-convert-rate-table');
        ...
        var tableWrapper = jQuery('#operation-convert-rate-table_wrapper');
        ...
        $('#operation-convert-rate-table-export').click(function (e) {
            e.preventDefault();
            ...
            location.href = "/operation/convertRateOfOrder/exportExcel?queryParamStr=" + JSON.stringify(queryParams);
        });
    }
    ...
    return {
        ...
        init: function () {
            activeMenu('/operation/convertRateOfOrder');
            initSelect();
            initTable();
        }
