...
require(
    ...
    function (ec) {
        ...
        var chart = ec.init(document.getElementById('overViewChart'), 'macarons');
        ...
        var beginDate = $("#flow_overview_startDate").val();
        var endDate = $("#flow_overview_endDate").val();
        var url = "flow/overview/data?startDate=" + beginDate + "&endDate=" + endDate;
        $.ajax({
            type: "POST",
            async: false, //同步执行
            dataType: "json",
