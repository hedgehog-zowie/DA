...
import com.iuni.data.persist.model.distribution.StockMoveDetailsQueryDto;
import com.iuni.data.persist.model.distribution.StockMoveDetailsTableDto;
 ...
 */
@Controller("stockMoveDetailsControllerOfDistribution")
@RequestMapping("/distribution/stockMoveDetails")
public class StockMoveDetailsController {
    ...
    public ModelAndView queryTable(@ModelAttribute("queryParam") StockMoveDetailsQueryDto queryParam) {
        ...
        modelAndView.setViewName(PageName.distribution_stock_move_details.getPath());
