package com.iuni.data.webapp.annotation.resolver;

import com.iuni.data.webapp.annotation.FormModel;
import com.iuni.data.webapp.annotation.MapWapper;
...
public class FormModelMethodArgumentResolver extends BaseMethodArgumentResolver {
    ...
    /**
     * Extension point to setBasicInfoForCreate the model attribute if not found in the model.
