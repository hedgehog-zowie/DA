 ...
 */
@Controller("rebatesDetailsControllerOfFinancial")
@RequestMapping("/financial/rebatesDetails")
public class RebatesDetailsController {

    private static final Logger logger = LoggerFactory.getLogger(RebatesDetailsController.class);
    ...
    public ModelAndView queryTable() {
        RebatesDetailsQueryDto queryParam= new RebatesDetailsQueryDto();
        queryParam.setDateRangeString(StringUtils.getLastSevenDaysRangeString());
        return queryTable(queryParam);
    }

    @RequestMapping("query")
    public ModelAndView queryTable(@ModelAttribute("queryParam") RebatesDetailsQueryDto queryParam) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName(PageName.financial_rebates_details.getPath());
    ...
    public String exportExcel(String queryParamStr, HttpServletResponse response) {
        ...
        try {
            ...
            sheetDataList.add(new ExcelUtils.SheetData("返利明细", RebatesDetailsTableDto.generateTableHeader(), RebatesDetailsTableDto.generateTableData(resultList)));
