...
public class TradeRecord {
    ...
    public TradeRecord copy(com.taobao.api.domain.TradeRecord tradeRecord) {
        this.alipayOrderNo = tradeRecord.getAlipayOrderNo();
        this.createTime = DateUtils.dateToSimpleDateStr(tradeRecord.getCreateTime(), "yyyy-MM-dd HH:mm:ss");
        this.alipayOrderNo = tradeRecord.getAlipayOrderNo();
        this.merchantOrderNo = tradeRecord.getMerchantOrderNo();
        this.orderType = tradeRecord.getOrderType();
        this.orderStatus = tradeRecord.getOrderStatus();
        this.ownerUserId = tradeRecord.getOwnerUserId();
        this.ownerLogonId = tradeRecord.getOwnerLogonId();
        this.ownerName = tradeRecord.getOwnerName();
        this.oppositeUserId = tradeRecord.getOppositeUserId();
        this.oppositeName = tradeRecord.getOppositeName();
        this.oppositeLogonId = tradeRecord.getOppositeLogonId();
        this.orderTitle = tradeRecord.getOrderTitle();
        this.totalAmount = tradeRecord.getTotalAmount();
        this.serviceCharge = tradeRecord.getServiceCharge();
        this.orderFrom = tradeRecord.getOrderFrom();
        this.modifiedTime = DateUtils.dateToSimpleDateStr(tradeRecord.getModifiedTime(), "yyyy-MM-dd HH:mm:ss");
        this.inOutType = tradeRecord.getInOutType();
        return this;
    }
