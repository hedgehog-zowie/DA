...
public class CryptUtils {
     ...
     */
    public static String generateSign(String data, String timestamp, String secret) throws NoSuchAlgorithmException, InvalidKeyException {
        data = data + timestamp;
        return CryptUtils.hmacSha1(data.getBytes(), secret.getBytes());
    }
